...
return{...prev,[name]:value}
    ...
    return ( 
        ...
        <div className="news--box--flex">
            <div className='news--text'><span>Subscribe to our <br/> Newslatter & Never miss <br/>latest updates</span></div>
...
<button className='btn--sub--news'  onClick={(e)=>{e.preventDefault()}}>Submit</button>
            </form>
        </div>
      ...
      <div className='footer---flex'>
         <img src='logo.svg'/>
            ...
            <ul className='icons--footer'> <li className='items--nav--social--btn'>
                    <button><a href='https://www.linkedin.com/'> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M1.92133 0C0.860667 0 0 0.860667 0 1.92133C0 2.982 0.860667 3.86067 1.92133 3.86067C2.982 3.86067 3.84267 2.982 3.84267 1.92133C3.842 0.860667 2.98133 0 1.92133 0V0Z" fill="white"/>
                    ...
                    <button><a href='https://www.facebook.com/'> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.54 2.65667H12.0007V0.112667C11.7487 0.078 10.882 0 9.87267 0C7.76667 0 6.324 1.32467 6.324 3.75933V6H4V8.844H6.324V16H9.17333V8.84467H11.4033L11.7573 6.00067H9.17267V4.04133C9.17333 3.21933 9.39467 2.65667 10.54 2.65667V2.65667Z" fill="white"/>
                    ...
                    <button><a href='https://www.instagram.com/'> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M12.2706 4.6889C12.8004 4.6889 13.2299 4.2594 13.2299 3.72958C13.2299 3.19976 12.8004 2.77026 12.2706 2.77026C11.7408 2.77026 11.3113 3.19976 11.3113 3.72958C11.3113 4.2594 11.7408 4.6889 12.2706 4.6889Z" fill="white"/>
        ...
        <p className='copy'>CopyRight &copy;  Hahakim2022 react js </p>
</div>
     );
}
